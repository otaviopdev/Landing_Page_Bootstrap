...
![Gif](./assets/images/landing_page_bootstrap.gif)
...
A Landing Page Bootstrap foi desenvolvida com HTML5, CSS3 e Bootstrap, cujo objetivo é demonstrar o meu aprendizado.
...
Antes de começar, é bom ter um editor para trabalhar com o código, como: [VSCode](https://code.visualstudio.com/). Clone este repositório usando git clone: https://github.com/otaviopdev/Landing_Page_Bootstrap.git ou clique em Code/Download ZIP. Clique no arquivo "index.html" e veja a aplicação.
...
Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/otaviopdev/Landing_Page_Bootstrap/blob/main/LICENSE) para mais detalhes.
